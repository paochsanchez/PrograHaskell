//Tarea 1 - Paola Chinchilla - 2019065008
use('tarea1');
...
db.restaurantes.find({"grades.score" : {$gt:70},"cuisine" : {$ne : "American "},"address.coord.0" : {$lt : -65.754168} })

//12.12. Write a MongoDB query to find the restaurants which do not prepare any cuisine of 'American' and achieved a score more than 70 and located in the longitude less than -65.754168.
db.restaurantes.find({"grades.score" : {$gt:70},"cuisine" : {$ne : "American "},"address.coord.0" : {$lt : -65.754168} })
...
db.restaurantes.find({$or : [{"borough" : "Staten Island"},{"borough" : "Queens"}, {"borough" : "Bronx"},{"borough" : "Brooklyn"} ]},{ "_id": 0,"restaurant_id" : 1,"name" : 1,"borough" : 1,"cuisine" : 1})

//19. Write a MongoDB query to find the restaurant Id, name, borough and cuisine for those restaurants which are not belonging to the borough Staten Island or Queens or Bronxor Brooklyn.
db.restaurantes.find({$nor : [{"borough" : "Staten Island"},{"borough" : "Queens"}, {"borough" : "Bronx"},{"borough" : "Brooklyn"} ]},{ "_id": 0,"restaurant_id" : 1,"name" : 1,"borough" : 1,"cuisine" : 1})

//20. Write a MongoDB query to find the restaurant Id, name, borough and cuisine for those restaurants which achieved a score which is not more than 10.
db.restaurantes.find({"grades" : { $elemMatch: {score: {$lt:10}}} },{"restaurant_id" : 1,"name" : 1,"borough" : 1,"cuisine" : 1})

//21. Write a MongoDB query to find the restaurant Id, name, borough and cuisine for those restaurants which prepared dish except 'American' and 'Chinees' or restaurant's name begins with letter 'Wil'.
db.restaurantes.find({$or : [ {name : {$regex : /^Wil/}}, {$and: [{"cuisine" : {$ne :"American "}},{"cuisine" : {$ne :"Chinees"}}]}]},{ "_id": 0,"restaurant_id" : 1,"name" : 1,"borough" : 1,"cuisine" : 1})

//22. Write a MongoDB query to find the restaurant Id, name, and grades for those restaurants which achieved a grade of "A" and scored 11 on an ISODate "2014-08-11T00:00:00Z" among many of survey dates..
db.restaurantes.find({"grades": { $elemMatch: { $and : [{ "grade": "A" },{"score":11},{"date": ISODate("2014-08-11T00:00:00Z")}]}} },{ "_id": 0,"restaurant_id": 1, "name": 1, "grades": 1});

//23. Write a MongoDB query to find the restaurant Id, name and grades for those restaurants where the 2nd element of grades array contains a grade of "A" and score 9 on an ISODate "2014-08-11T00:00:00Z".
db.restaurantes.find({"grades.1.date" : ISODate("2014-08-11T00:00:00Z"),"grades.1.grade" : "A","grades.1.score" : 9 }, {"_id" : 0,"restaurant_id" : 1,"name" : 1,"grades" : 1});

//24. Write a MongoDB query to find the restaurant Id, name, address and geographical location for those restaurants where 2nd element of coord array contains a value which is more than 42 and upto 52..
db.restaurantes.find({$and : [{"address.coord.1": {$gt : 42}}, {"address.coord.1": {$lte : 52} }]},{"_id" : 0,"restaurant_id" : 1,"name" : 1,"address" : 1,"coord" : 1});
...
db.restaurantes.find({"address.street" : { $exists : true }} ).count() == db.restaurantes.count()
